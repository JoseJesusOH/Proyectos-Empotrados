...
void loop() {
  ...
  strcpy(estado,comando);
          //strcpy(estado,comando);
  Serial.print("Comando despuescrear:");
  Serial.println(comando);
    Serial.print("Estado despuescrear:");
  ...
  delay(3000);
    ...
    if (Serial.available() > 0){
          ...
          Serial.print("Estado despuescopiar:");
  Serial.println(estado);
        Serial.print("Comando despuesprimerIF:");
  Serial.println(comando);  
